...
export const KARANAS: Record<string, ElementInfo> = {
  ...
  Gara:        { description: 'Gara — moveable Karana, ruled by Earth goddess.', isAuspicious: true,  reason: 'Auspicious for construction.', idealFor: 'Construction, real estate, groundwork' },
...
export const MUHURTA_INFO: Record<string, { name: string; description: string; howToUse: string; isAuspicious: boolean; idealFor: string }> = {
  ...
  vidalYoga: {
    name: 'Vidal Yoga',
    description: 'Inauspicious period active when the Moon transits certain Nakshatra combinations — separating, divisive energy.',
  ...
  durMuhurta: {
    name: 'Dur Muhurta',
    description: 'One inauspicious period per day (~48 min), weekday-dependent. Friday has two such periods.',
